...
class ConjugationEngine:
    def __init__(self, dictionary_path: str, db=None):
    ...
    def load_dictionary(self) -> Dict:
        """Cargar el diccionario de Nasa Yuwe desde MySQL o JSON"""
        # Intentar cargar desde MySQL primero
        if self.db is not None:
            try:
                return self.db.get_all_dictionary()
            except Exception:
                pass
        else:
            try:
